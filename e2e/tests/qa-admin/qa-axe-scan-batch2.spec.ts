...
const ROUTES = [
  '/bookings/buses', '/bookings/restaurants',
  '/cms/broadcasts', '/cms/news', '/cms/offers', '/cms/pages', '/cms/templates',
  '/finance/payments', '/finance/refunds', '/finance/reports', '/finance/withdrawals',
  '/partners/listings',
];

test.describe.serial('EXHAUSTIVE: automated accessibility scan (axe-core) — web-admin batch 2 (remaining routes)', () => {
  let sharedPage: Page;
