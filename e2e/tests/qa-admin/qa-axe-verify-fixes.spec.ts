...
const ROUTES = ['/dashboard', '/users', '/partners/list', '/bookings/hotels', '/support',
  '/cms/templates', '/finance/payments', '/finance/refunds', '/finance/reports', '/team',
  '/cms/broadcasts', '/settings'];

test.describe.serial('VERIFY FIXES: web-admin axe re-scan', () => {
  let sharedPage: Page;
