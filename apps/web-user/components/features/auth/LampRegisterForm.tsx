  ...
  ({ label, icon: Icon, rightElement, ...props }, ref) => (
    <div className="space-y-1">
      ...
      <div className="relative group">
        ...
        <input
          ref={ref}
          className={`w-full bg-zinc-950/50 border border-zinc-800 rounded-xl py-3 ${Icon ? 'pl-10' : 'pl-4'} pr-4 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all shadow-inner`}
          {...props}
        />
        {rightElement && (
