...
export function UzumCheckoutFrame({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="relative flex h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-900">
        <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3 dark:border-slate-800">
          <span className="text-sm font-semibold text-slate-900 dark:text-white">
            Xavfsiz to&apos;lov — Uzum Checkout
          </span>
          <button
            type="button"
            onClick={onClose}
        ...
        {verifying && (
          <div className="flex items-center gap-2 border-b border-slate-200 bg-primary-50 px-4 py-2 text-xs font-medium text-primary-700 dark:border-slate-800 dark:bg-primary-950/40 dark:text-primary-300">
        ...
        {failed && (
          <div className="border-b border-red-200 bg-red-50 px-4 py-2 text-xs font-medium text-red-700 dark:border-red-900/50 dark:bg-red-950/40 dark:text-red-300">
