...
export default function LampLoginForm({
  ...
  return (
    <LampAuthLayout locale={locale}>
      ...
      {mode !== "login" && (
        <button onClick={() => changeMode("login", -1)} className="absolute top-8 left-8 text-zinc-500 hover:text-white transition-colors z-50">
      ...
      <div className="relative min-h-[400px] flex flex-col justify-center overflow-hidden">
        <AnimatePresence custom={direction} mode="wait">
          ...
          {mode === "login" && (
            ...
            >
              <div className="mb-8 text-center">
                <h2 className="text-2xl font-bold text-white mb-1">{dict.title || "Xush kelibsiz"}</h2>
                <p className="text-zinc-400 text-sm">{dict.passwordLoginSubtitle || "Tizimga kirish uchun ma'lumotlaringizni kiriting."}</p>
              </div>
              ...
              <form action={loginFormAction} className="space-y-4">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center pl-1">
                    ...
                    <button type="button" onClick={() => changeMode("forgot-email", 1)} className="text-xs text-blue-500 hover:text-blue-400 transition-colors">
              ...
              <p className="mt-6 text-center text-sm font-medium text-zinc-400">
                ...
                <button onClick={handleRegisterClick} className="font-bold text-blue-500 hover:text-blue-400 transition-colors">
          ...
          {mode === "forgot-email" && (
            ...
            >
              <div className="mb-4 text-center">
                <h2 className="text-2xl font-bold text-white mb-1">{dict.forgotPasswordTitle || "Parolni unutdingizmi?"}</h2>
                <p className="text-zinc-400 text-sm">{dict.forgotPasswordSubtitle || "Emailingizni kiriting, tiklash kodini yuboramiz."}</p>
              </div>
              ...
              <motion.button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl py-3 flex items-center justify-center gap-2 transition-all shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] disabled:opacity-70 disabled:cursor-not-allowed"
              >
          ...
          {mode === "forgot-code" && (
            ...
            >
              <div className="mb-4 text-center">
                <h2 className="text-2xl font-bold text-white mb-1">{dict.resetCodeTitle || "Tasdiqlash kodi"}</h2>
                <p className="text-zinc-400 text-sm">{dict.resetCodeSubtitle || "Emailingizga kelgan 6 xonali kodni kiriting."}</p>
              </div>
          ...
          {mode === "reset-password" && (
            ...
            >
              <div className="mb-4 text-center">
                <h2 className="text-2xl font-bold text-white mb-1">{dict.newPasswordTitle || "Yangi parol"}</h2>
                <p className="text-zinc-400 text-sm">{dict.newPasswordSubtitle || "Yangi parolingizni kiriting."}</p>
              </div>
